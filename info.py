...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'SK_MoviesOffl_Support')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", 'JOIN @SK_MoviesOffl')
...
AUTO_DELETE_SECONDS = int(environ.get('AUTO_DELETE_SECONDS', 10644300))
AUTO_DELETE = environ.get('AUTO_DELETE', True)
if AUTO_DELETE == "True":
    AUTO_DELETE = True

SHORTNER_SITE = environ.get('SHORTNER_SITE', 'tglink.in')
SHORTNER_API = environ.get('SHORTNER_API', 'a4ff53b8363d8025d486eafcf015c975f8424478')
